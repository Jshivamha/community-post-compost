...
const Mycommunities = () => {
    ...
    const getCommunities = async () => {
        try{
            const response = await axios.post('http://localhost:3000/u/mycommunity/getallcommunities')
            setgetAllComms(response.data)
            console.log(getAllComms);
        }
        catch(err){
            console.log(err);
        }
            ...
            <div className='flex flex-col w-[800px] max-h-fit space-y-8'>
                <div className='flex justify-between'>
                    ...
                    <div className="space-x-4">
                        <Button className='text-[20px] font-mono max-w-fit px-4 py-1 rounded-md bg-gray-900'>Join</Button>
                ...
                <div className='flex flex-col space-y-8'>
                    <div className='border rounded-md border-gray-800 p-4'>
                        <div className="space-y-1">
                            <h4 className="text-2xl font-semibold font-mono leading-none">Community Title</h4>
