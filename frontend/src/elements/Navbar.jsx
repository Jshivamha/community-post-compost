...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 w-full shadow-lg z-50">
      <div className={"container mx-auto px-8 py-6 flex items-center " + (isAuthenticated ? "" : "justify-between")}>
        <div className='flex items-center'>
          <svg className='h-6 mr-2' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#ffffff" d="M50.7 58.5L0 160l208 0 0-128L93.7 32C75.5 32 58.9 42.3 50.7 58.5zM240 160l208 0L397.3 58.5C389.1 42.3 372.5 32 354.3 32L240 32l0 128zm208 32L0 192 0 416c0 35.3 28.7 64 64 64l320 0c35.3 0 64-28.7 64-64l0-224z"/></svg>        
